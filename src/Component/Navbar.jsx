...
//                 alt="User Avatar"
//                 className="w-10 h-10 rounded-full border-2 border-blue-500 object-cover hover:scale-105 transition-transform"
//               />
//               <button
//                 onClick={logOut}
...
//               />
//               <span className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
