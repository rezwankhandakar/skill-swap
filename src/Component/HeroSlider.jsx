...
//     img: "https://i.postimg.cc/CMVL2rwn/skillswap-hero.png"
//   },
//   {
//     id: 2,
//     title: "Connect Locally",
//     subtitle: "Meet mentors in your area",
//     desc: "Find and book sessions with local skill providers easily.",
//     img: "https://i.postimg.cc/6QZxN9y7/digitalmarketing.png"
//   },
//   {
//     id: 3,
//     title: "Grow Together",
//     subtitle: "Learn and teach",
//     desc: "Share your knowledge and learn new skills from others.",
//     img: "https://i.postimg.cc/fT4dkQpf/photography.png"
//   }
// ];
...
//     }, 4000); // ৪ সেকেন্ড পর স্লাইড চেঞ্জ হবে
...
//         <div
//           key={slide.id}
//           className={`absolute top-0 left-0 w-full h-full flex items-center justify-between px-6 md:px-16 transition-transform duration-1000 ease-in-out
...
//             <img src={slide.img} alt={slide.title} className="rounded-2xl shadow-lg" />
//           </div>
//         </div>
//       ))}
//     </div>
